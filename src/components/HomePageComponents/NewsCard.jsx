...
function NewsCard() {
  return (
        <div className="max-w-screen-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <Link href="#">
                <img className="rounded-t-lg" src={imgService} alt="" />
            </Link>
            <div className="p-5">
                <Link href="#">
